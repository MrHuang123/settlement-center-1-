                            ...
                            <Col span={3}>
                                {
                                    type=='new'?<Button onClick={()=>{
                                        this.searchName();
                                    }} style={{marginBottom:'24px'}}>查询商户名称</Button>:null
                                }
                            </Col>
                            <Col span={13} style={{display:'flex'}}>
                                <span style={{paddingBottom:'24px',display:'inline-block'}}><Spin spinning={merchantNameLoading}>商户名称：{this.state.merchantName}</Spin></span>
                            </Col>
                        </Row>
                                        ...
                                        <FormItem label="商户结算实时标志">
                                            {
                                                getFieldDecorator('actualCode', {
                                                    ...
                                                    rules: [
                                                        { required: true, message: '商户结算实时标志为空' },
                                                    ],
                                                })(
                                                    <OneSelect
                                                        style={{width:'100%'}}
                                        ...
                                        <FormItem label="商户结算类型">
                                            {
                                                getFieldDecorator('saToCode', {
                                                    ...
                                                    rules: [
                                                        { required: true, message: '商户结算类型为空' },
                                                    ],
                                                })(
                                                    <OneSelect
                                                        style={{width:'100%'}}
...
const mapState = (state) => {
    return {
        loading: state.loading.effects.merchantloanSet.asyncGetDetail || state.loading.effects.merchantloanSet.asyncReset || state.loading.effects.merchantloanSet.asyncNew,
        merchantNameLoading:state.loading.effects.merchantloanSet.asyncSearchName,
        sysAllDictItems: state.login.sysAllDictItems,
        detail:state.merchantloanSet.detail,
    };
};
const mapDispatch = (dispatch) => {
    return {
        getSysAllDictItems: dispatch.login.getSysAllDictItems,
        asyncGetDetail:dispatch.merchantloanSet.asyncGetDetail,
        asyncSearchName:dispatch.merchantloanSet.asyncSearchName,
        asyncReset:dispatch.merchantloanSet.asyncReset,
        asyncNew:dispatch.merchantloanSet.asyncNew,
    };
};
